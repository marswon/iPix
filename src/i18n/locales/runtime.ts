export const zhRuntime = {
  ...
  capability: {
    ...
    generationGateTitle: '允许 iPix 生成这一镜？',
    generationGateBatchTitle: '允许 iPix 生成这一批镜头？',
    generationGateMessage: '允许 iPix 在当前项目使用模型 {{model}}，最多花费 {{cost}}，{{shot}}？',
...
export const enRuntime = {
  ...
  capability: {
    ...
    generationGateTitle: 'Allow iPix to generate this shot?',
    generationGateBatchTitle: 'Allow iPix to generate this batch of shots?',
    generationGateMessage: 'Allow iPix to use {{model}} in the current project, spend up to {{cost}}, and {{shot}}?',
