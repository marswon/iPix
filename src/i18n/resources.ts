...
export const zhCN = {
  ...
  about: {
    ...
    replaySplash: '重看开屏动画',
    replaySplashDescription: 'iPix 启动时那段品牌开场，再放一遍',
...
export const en = {
  ...
  library: {
    ...
    watchHow: 'See how iPix creates a video',
  ...
  studio: {
    ...
    projectRecoveryMessage: 'iPix can restore the most recent valid automatic backup. The damaged file will be preserved as a separate copy.',
    ...
    initializeTitle: 'Initialize as a iPix project',
    initializeMessage:
  ...
  onboarding: {
    ...
    steps: {
      ...
      storyboard: { label: 'Plan one shot', hint: 'Ask iPix to turn your idea into shots in Create.' },
