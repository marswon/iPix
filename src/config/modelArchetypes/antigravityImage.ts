...
export const ANTIGRAVITY_IMAGE_ARCHETYPE: ModelArchetype = {
  ...
  sources: [{ url: "https://antigravity.google/docs/hooks/", checkedAt: "2026-08-27", vendorKey: "antigravity-cli",
    covers: "generate_image Prompt/ImageName/ImagePaths; four reference limit is the iPix adapter budget, not a claimed upstream limit" }],
  ...
  modes: [
    ...
    { id: "i2i", intent: "edit", vendorTerm: "改图", hint: "iPix 每次最多处理四张参考图", promptRequired: true,
