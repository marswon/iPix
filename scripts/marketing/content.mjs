...
const zhCN = {
  ...
  hero: {
    ...
    titleEmphasis: '打下来。',
    lede: '模型、会员、API、ComfyUI，都用你自己的。iPix 把脚本、分镜、生成、剪辑和 AI 助手放进一个开源工作台，不再为平台套餐、重复工具和低效试错多付一遍。',
    download: '下载 iPix',
    ...
    truth: '生成仍会消耗你所选服务的额度；iPix 减少平台溢价、重复订阅、无效生成和重复劳动。',
    ribbon: ['平台溢价', '重复订阅', '无效抽卡', '重复劳动'],
    imageAlt: 'iPix 将角色参考、生成画布和视频时间线放在同一个项目中',
  },
  cost: {
    ...
    items: [
      ...
      },
      {
        ...
        imageAlt: 'iPix 自动化与权限设置中的 AI 助手接入入口',
      },
      {
        id: 'lockin',
        label: '迁移成本',
  ...
  stack: {
    ...
    description: 'iPix 不和即梦、ComfyUI 或模型 API 竞争。它负责把这些生成能力组织成一条能编辑、能恢复、能交付的视频工作流。',
    rows: [
      { label: '生成引擎', items: ['即梦会员', '任意 API', '本地 ComfyUI'], result: '图片、视频、文本与声音' },
      { label: '生产工作台', items: ['iPix 画布', '视觉锚点', '真实时间线'], result: '一版可以继续修改的初稿' },
  ...
  agent: {
    ...
    description: 'Codex、Claude Code、Cursor 可以在 iPix 里建立项目、拆分镜、连接参考、调用你配置的模型并推进初稿。',
    bullets: ['生成前看清模型和支出后果', '预算、采用和导出仍由你批准', '任务中断后可以恢复，不重复下单'],
    imageAlt: 'iPix 自动化与权限设置中的 Claude Code、Codex 和 Cursor 接入入口',
  },
  openSource: {
  ...
  community: {
    ...
    group: {
      ...
      title: '加入 iPix 用户群，一起把成本继续打下来。',
      description: '交流工作流、反馈问题、获取版本动态。群码失效时可以直接添加作者微信。',
      discussion: 'GitHub Issues',
      qrAlt: 'iPix 用户群微信二维码',
      qrCaption: '扫码加入 iPix 用户群',
    },
    project: {
  ...
  download: {
    ...
    macGuideSummary: '当前 macOS 安装包未使用 Apple Developer ID 签名，也未经过 Apple 公证。请只使用本页或 iPix GitHub 官方仓库的下载链接。',
    macSteps: [
      '下载对应的 DMG，把 iPix 拖到“应用程序”。',
      '在 Finder 的“应用程序”中右键 iPix，选择“打开”，再确认“打开”。',
      '如果仍被拦截，打开“系统设置” → “隐私与安全”，找到 iPix 后点击“仍要打开”。',
    ],
    macDamaged: '仅当 macOS 提示 iPix“已损坏”时：先确认安装包来自上述官方链接，再打开“终端”运行：',
    macCommand: 'xattr -dr com.apple.quarantine "/Applications/iPix.app"',
    macSafety: '不需要、也不要全局关闭 Gatekeeper。',
  },
  a11y: {
    skip: '跳到主要内容',
    filmTitle: 'iPix 真实工作流',
    close: '关闭',
    authorTitle: '添加作者微信',
...
const english = {
  ...
  ogLocale: 'en_US',
  meta: {
    title: 'iPix — Bring the cost of AI video down',
    ...
    imageAlt: 'iPix, an open-source local-first workbench for lower-cost AI video production',
  },
  nav: {
  ...
  hero: {
    ...
    titleEmphasis: 'down.',
    lede: 'Use your own models, subscriptions, APIs, and ComfyUI. iPix brings scripts, storyboards, generation, editing, and AI assistants into one open-source workbench, so you do not pay again for platform bundles, duplicate tools, and inefficient retries.',
    download: 'Download iPix',
    github: 'Help improve it on GitHub ↗',
    contribution: 'iPix is still evolving. Found a problem? Open an issue. Want to help shape it? Send a pull request.',
    ...
    truth: 'Generation still uses the quota of your chosen service. iPix reduces platform markup, duplicate subscriptions, wasted generations, and repetitive work.',
    ribbon: ['Platform markup', 'Duplicate tools', 'Wasted rerolls', 'Repetitive work'],
    imageAlt: 'iPix keeps character references, the generation canvas, and video timeline in one project',
  },
  cost: {
    eyebrow: 'WHY IT COSTS LESS',
    ...
    items: [
      {
        ...
        image: '/assets/screen-canvas-2026-08-17.png',
        imageAlt: 'iPix generation canvas and model workflow',
      },
      {
        id: 'trial',
        label: 'Iteration',
        ...
        image: '/assets/screen-3d-2026-08-17.png',
        imageAlt: 'Character and camera references in the iPix 3D director stage',
      },
      {
        id: 'labor',
        label: 'Labor',
        ...
        image: '/assets/screen-agentic-2026-08-17.png',
        imageAlt: 'AI assistant connection entry in iPix automation and permission settings',
      },
      {
        id: 'lockin',
        label: 'Ownership',
        ...
        image: '/assets/screen-timeline-2026-08-17.png',
        imageAlt: 'A iPix project and timeline stored on the local computer',
      },
    ],
  },
  stack: {
    ...
    description: 'iPix does not compete with Dreamina, ComfyUI, or model APIs. It organizes those capabilities into a video workflow you can edit, recover, and deliver.',
    rows: [
      { label: 'Generation', items: ['Dreamina', 'Any API', 'Local ComfyUI'], result: 'Image, video, text, and sound' },
      { label: 'Workbench', items: ['iPix canvas', 'Visual anchors', 'Real timeline'], result: 'A first cut you can keep editing' },
    ...
    steps: [
      {
        ...
        label: 'Write & plan',
        image: '/assets/screen-script-2026-08-17.png',
        imageAlt: 'iPix story and storyboard workspace',
      ...
      },
      {
        ...
        image: '/assets/screen-3d-2026-08-17.png',
        imageAlt: 'iPix 3D director stage and visual references',
      ...
      },
      {
        ...
        image: '/assets/screen-canvas-2026-08-17.png',
        imageAlt: 'iPix generation canvas',
  ...
  agent: {
    ...
    description: 'Codex, Claude Code, and Cursor can create iPix projects, break down shots, connect references, call your configured models, and advance an editable first cut.',
    ...
    imageAlt: 'Claude Code, Codex, and Cursor connection entry in iPix automation and permission settings',
  },
  openSource: {
    eyebrow: 'OPEN SOURCE IS THE BUSINESS MODEL',
  ...
  community: {
    ...
    group: {
      eyebrow: 'USER COMMUNITY',
      title: 'Join the iPix community and keep pushing costs down.',
      ...
      discussion: 'GitHub Issues',
      qrAlt: 'WeChat QR code for the iPix user group',
      qrCaption: 'Scan to join the iPix WeChat group',
    },
    project: {
      eyebrow: 'FOR REAL PROJECTS',
  ...
  footer: {
    product: 'iPix · Local-first AI video workbench',
  ...
  download: {
    ...
    description: 'iPix downloads directly when the platform is known. If the Mac chip cannot be detected reliably, choose the matching installer.',
    windows: 'Windows x64',
    ...
    macGuideSummary: 'The current macOS build is not Apple Developer ID signed or notarized. Only use download links on this site or in the official iPix GitHub repository.',
    macSteps: [
      'Download the matching DMG and drag iPix to Applications.',
      'In Finder, right-click iPix in Applications, choose Open, then confirm Open.',
      'If it is still blocked, open System Settings → Privacy & Security, find iPix, and click Open Anyway.',
    ],
    macDamaged: 'Only if macOS says iPix is “damaged”: confirm the installer came from an official link above, then open Terminal and run:',
    macCommand: 'xattr -dr com.apple.quarantine "/Applications/iPix.app"',
    macSafety: 'You do not need to disable Gatekeeper globally, and should not do so.',
  },
  a11y: {
    skip: 'Skip to main content',
    filmTitle: 'The iPix workflow',
    close: 'Close',
