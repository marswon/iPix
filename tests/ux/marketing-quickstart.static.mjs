...
async function auditViewport(browser, name, viewport) {
  ...
  assert(result.links.includes('https://github.com/marswon/iPix/releases/download/v0.21.0-gettoken.6/iPix.Preview-mac-arm64.dmg'), `${name}: Mac arm64 下载链接在位`)
  assert(result.links.includes('https://github.com/marswon/iPix/releases/download/v0.21.0-gettoken.6/iPix.Preview-mac-x64.dmg'), `${name}: Mac Intel 下载链接在位`)
  assert(result.links.includes('https://github.com/marswon/iPix/releases/download/v0.21.0-gettoken.6/iPix.Preview-win-x64.exe'), `${name}: Windows 下载链接在位`)
