...
| 系统 | 安装包 |
|---|---|
| macOS Apple Silicon（M1/M2/M3/M4） | [iPix.Preview-mac-arm64.dmg](https://github.com/marswon/iPix/releases/download/v0.21.0-gettoken.7/iPix.Preview-mac-arm64.dmg) |
| macOS Intel x64（macOS 12.0+） | [iPix.Preview-mac-x64.dmg](https://github.com/marswon/iPix/releases/download/v0.21.0-gettoken.7/iPix.Preview-mac-x64.dmg) |
| Windows 10/11 x64 | [iPix.Preview-win-x64.exe](https://github.com/marswon/iPix/releases/download/v0.21.0-gettoken.7/iPix.Preview-win-x64.exe) |

完整发布页：[v0.21.0-gettoken.7](https://github.com/marswon/iPix/releases/tag/v0.21.0-gettoken.7)
...
请使用 `v0.21.0-gettoken.7` 或更高版本。该版本会把 `1:1 + 1K` 转换成上游要求的像素尺寸。
